...
gulp.task('html', () => {
  return gulp.src(path.src.html).pipe(reload({ stream: true }));
});
...
gulp.task('build', gulp.parallel('styles', 'scripts', gulp.series('images')));

gulp.task(
  'default',
  gulp.parallel('browserSync', 'watch', 'styles', 'scripts')
);
